...
%     import numpy as np;
    ...
    for i = 1:size(K1)
        K1_tot = K1_tot + K1(i)*temp.^i;
        K2_tot = K2_tot + K2(i)*temp.^i;
        K3_tot = K3_tot + K3(i)*temp.^i;
        
        L1_tot = L1_tot + L1(i)*temp.^i;
        L2_tot = L2_tot + L2(i)*temp.^i;
        L3_tot = L3_tot + L3(i)*temp.^i;
    end
