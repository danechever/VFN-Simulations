function [SQSUM,circum_diam] = makeKeckPupilLeastSquares( vars, seed, idealPhz)
    ...
    %Compute Residuals
    residual = (angle(optField) - angle(ideal));
    SQSUM = sum(residual.^2,'all');
    disp(SQSUM);
%     figure(10);
%     txt1 = ['Sum of Squares: ' num2str(sqsum1)];
%     text(-0.5,0,txt1);
end